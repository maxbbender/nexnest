...
jQuery.extend({
	...
	dobPicker: function(params) {
		...
		$(params.daySelector).append('<option selected="true" disabled="disabled" value="">' + params.dayDefault + '</option>');
		$(params.monthSelector).append('<option selected="true" disabled="disabled" value="">' + params.monthDefault + '</option>');
		$(params.yearSelector).append('<option selected="true" disabled="disabled" value="">' + params.yearDefault + '</option>');
